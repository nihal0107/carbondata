...
public class SecondaryIndexModel extends IndexModel {
  final String indexName; // Secondary Index name
  final String currentSegmentId; // Segment Id to prune
  final List<String> validSegmentIds; // Valid segment Ids for Secondary Index pruning
  final PositionReferenceInfo positionReferenceInfo; // Position reference information
